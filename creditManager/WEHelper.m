...
+ (NSString*)fullTimeStringWithTime:(NSString *)time
{
    ...
    NSString * string=[NSString stringWithFormat:@"%04ld年%02ld月%02ld日",(long)[component year],(long)[component month],(long)[component day]];
    return string;
}
...
+(NSString*)timeNumberConvertTime:(NSString*)t {
    NSTimeInterval time = [t doubleValue] + 28800;//因为时差问题要加8小时 == 28800 sec
...
+ (NSDate*)dateConcertCurrentDate:(NSDate*)date {
